...
pcl_file = "imakon_0_3_real_PCL.pcl";
...
text {
	caption = "Wie häufig, glauben Sie, folgte diesem Bild der elektrische Reiz? \n\n 0 = nie        1 = manchmal        2 = häufig        3 = immer";
	font_size = 36;
	font = "Arial";
	font_color = 210,210,210;
	background_color = 0,0,0;
...
text {
	caption = "Wie häufig, glauben Sie, folgte diesem Bild die Vibration? \n\n 0 = nie        1 = manchmal        2 = häufig        3 = immer";
	font_size = 36;
	font = "Arial";
	font_color = 210,210,210;
	background_color = 0,0,0;
} contingency_neu_text;

text {
	caption = "Wie <u><b>unangenehm</b></u> finden Sie die Vorstellung, die mit diesem Symbol verknüpft ist? \n\n 0 = überhaupt nicht unangenehm            10 = extrem unangenehm\n\nFalls Sie keine Vorstellung mit diesem Symbol verknüpft haben, drücken Sie bitte die linke Taste.";
	font_size = 36;
	font = "Arial";
	font_color = 210,210,210;
	background_color = 0,0,0;
...
text{
	caption = "Wie <u><b>unangenehm</b></u> fanden Sie die Vibration zuletzt? \n\n 0 = überhaupt nicht unangenehm            10 = extrem unangenehm";
	font_size = 36;
	font = "Arial";
	font_color = 210,210,210;
	background_color = 0,0,0;
